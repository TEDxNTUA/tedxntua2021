...
TEDXNTUA_VENUE_ENABLED = env_bool('TEDXNTUA_VENUE_ENABLED', True)
TEDXNTUA_SHOW_LIVE = env_bool('TEDXNTUA_SHOW_LIVE', False)
TEDXNTUA_EASTER_EGGS = env_bool('TEDXNTUA_EASTER_EGGS', False)
TEDXNTUA_PARTNER_PANELS = env_bool('TEDXNTUA_PARTNER_PANELS', False)
